...
df = pd.read_csv("EXCEL/hospitales.csv", 
                 encoding='latin-1', sep=';')


df["Numero NIT"] = df["Numero NIT"].str.replace(",", "").str.replace('"', "").astype(int)


class NodoHospital:
    def __init__(self, nit, razon_social, sede, municipio):
        self.nit = nit
        self.razon = razon_social
        self.sede = sede
...
print("\n Hospital con NIT 58930322701:")
print(buscar_hospital(arbol.raiz, 58930322701))
